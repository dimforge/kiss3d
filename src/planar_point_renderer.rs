...
pub struct PlanarPointRenderer {
...
impl Default for PlanarPointRenderer {
    fn default() -> Self {
        Self::new()
    }
}

impl PlanarPointRenderer {
    /// Creates a new 2D points manager.
    pub fn new() -> PlanarPointRenderer {
    ...
    pub fn draw_point(&mut self, pt: Point2<f32>, color: Point3<f32>, size: f32) {
